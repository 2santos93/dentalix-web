        ...
        {days.map((day) => {
          ...
          return (
            <button
              ...
              data-date={day.date}
              className={[
                'flex min-h-[76px] flex-col gap-1 border-b border-r border-border p-1.5 text-left align-top transition-colors md:min-h-[104px]',
                'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary',
                day.inMonth ? 'hover:bg-bg' : 'bg-bg/60 hover:bg-bg',
            ...
            >
              <div className="flex items-center justify-between">
                ...
                {count > 0 && (
                  <span
                    aria-hidden
                    className="rounded-full bg-bg px-1.5 text-[10px] font-medium tabular-nums text-muted md:hidden"
                  >
                    {count}
                  </span>
                )}
              ...
              <div className="hidden flex-col gap-0.5 md:flex">
                {visible.map((a) => (
                  <span
                    key={a.id}
                    className="flex items-center gap-1 truncate rounded bg-bg px-1 py-0.5 text-[11px] leading-tight text-ink"
                  >
                    <span
                      aria-hidden
